...
typedef HeaderFormatter = Map<String,String> Function(String? accessToken);
typedef AuthResponseFormatter = AuthTokenObject Function(Map<String,dynamic> data);
...
class Authenticator extends RESTExecutor{
  ...
  refresh()async{
    ...
    await RESTExecutor(
      ...
      successCallback: (res){
        super.cache?.write(super.getKey(), res??Response());
      },
      errorCallback: (_){
        // logout();
      }
